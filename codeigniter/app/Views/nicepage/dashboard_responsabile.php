...
<html style="font-size: 16px;" lang="it"><head>
    ...
    <title>dashboard_responsabile</title>
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/dashboard_amministratore.css" media="screen">
    ...
    <meta property="og:title" content="dashboard_responsabile">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="it"><header class="u-clearfix u-header u-header" id="header" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="block-2">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div style="min-height: auto !important;" class="u-border-3 u-border-palette-4-base u-container-style u-group u-radius u-group-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
          <div class="u-container-layout u-container-layout-1">
			...
			<?php $N = sizeof($servizio);
				for ($i = 0; $i < $N; $i++) 
				{
					...
					<div style="margin-bottom: 30px;" class="u-border-4 u-border-palette-5-light-1 u-container-style u-custom-color-6 u-group u-hover-feature u-preserve-proportions u-radius u-shading u-shape-round u-group-2" data-href="<?php echo base_url('codeigniter/');?>servizio/<?= $id_servizio_i ?>" data-page-id="2792814567" title="Gestisci servizio" data-animation-out="0">
					  <div class="u-container-layout u-container-layout-2">
						<h3 style="width:auto" class="u-align-center u-text u-text-body-color u-text-3"><?= $servizio[$i]['nome'] ." (ID: ".$id_servizio_i.")"?></h3>
						<p class="u-align-center u-large-text u-text u-text-body-color u-text-variant u-text-4">Numero di segnalazioni: <?= $count_segnalazioni[$i]['coalesce'] ?></p>
					  </div>
					</div>
			<?php } ?>
...
<section class="u-clearfix u-section-3" id="block-4" style="height: auto !important; min-height: unset !important;">

<div class="u-clearfix u-sheet u-sheet-1" style="min-height: auto !important;">

        <p class="u-align-center u-hover-feature u-text u-text-2 " style="margin-top: 0px;margin-bottom: 30px;"><span class="u-file-icon u-icon u-text-palette-4-base u-icon-1" data-href="<?php echo base_url('codeigniter/');?>" data-page-id="12247714" title="Home"><img src="<?php echo base_url();?>assets/images/69524-a9ccadc1.png" alt=""></span>&nbsp;
        </p>
      </div> 
