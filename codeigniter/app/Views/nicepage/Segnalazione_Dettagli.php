...
<html style="font-size: 16px;" lang="it"><head>
    ...
    <title>Segnalazione_Dettagli</title>
    <link rel="stylesheet" href="<?php echo base_url();?>assets/nicepage.css" media="screen">
<link rel="stylesheet" href="<?php echo base_url();?>assets/Segnalazione_Dettagli.css" media="screen">
    ...
    <meta property="og:title" content="Segnalazione_Dettagli">
      ...
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        <div class="u-border-3 u-border-palette-4-base u-container-style u-group u-radius u-group-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
          <div class="u-container-layout u-valign-bottom u-container-layout-1">
            <h2 style="margin:auto" class="u-align-left u-text u-text-default u-text-1">ID Segnalazione: <?= $segnalazione['id_segnalazione'] ?><span style="text-decoration: underline !important;"></span>
            </h2>
            <div class="u-border-2 u-border-palette-4-base u-container-style u-expanded-width u-group u-palette-5-base u-radius u-shape-round u-group-2">
              <div class="u-container-layout u-container-layout-2">
                <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-3">
                  <div class="u-container-layout u-container-layout-3">
                    <p class="u-align-left u-text u-text-body-color u-text-2"><?= $segnalazione['timestamp']; ?></p>
                    <h4 class="u-align-center u-text u-text-default u-text-3">Timestamp</h4>
                  </div>
                </div>
                <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-4">
                  <div class="u-container-layout u-container-layout-4">
                    <p class="u-align-left u-text u-text-body-color u-text-4"><?= $segnalazione['email_utente']; ?></p>
                    <h4 class="u-align-center u-text u-text-default u-text-5">Email Utente</h4>
                  </div>
                </div>
                <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-5">
                  <div class="u-container-layout u-container-layout-5">
                    <p class="u-align-left u-text u-text-body-color u-text-6"><?= $servizio['nome']; ?></p>
                    <h4 class="u-align-center u-text u-text-default u-text-7">Servizio</h4>
                  </div>
                </div>
                <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-6">
                  <div class="u-container-layout u-container-layout-6">
                    <p class="u-align-left u-text u-text-body-color u-text-8"><?= $tipologia['nome']; ?></p>
                    <h4 class="u-align-center u-text u-text-default u-text-9">Tipologia</h4>
                  </div>
                </div>
				
                 <div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-6">
                  <div class="u-container-layout u-container-layout-6">
                    <p class="u-align-left u-text u-text-body-color u-text-8">
					<?php if($segnalazione['descrizione']==''){
							echo "Nessuna descrizione fornita";
					}else 
							{echo esc($segnalazione['descrizione']);}?>
					</p>
                    <h4 class="u-align-center u-text u-text-default u-text-9">Descrizione</h4>
                  </div>
                </div>
                
				<div class="u-container-style u-expanded-width u-group u-shape-rectangle u-group-8">
                  <div class="u-container-layout u-container-layout-8">
                    <p class="u-align-left u-text u-text-body-color u-text-12">
					<?php if($segnalazione['allegato']==''){
							echo "Nessun allegato";
					}else 
						{?><a target="_blank" href="<?= base_url(); ?>assets/allegati_segnalazioni/<?= $segnalazione['allegato']; ?>"/>Visualizza allegato</a>
					<?php }?>					
						
					</p>
                    <h4 class="u-align-center u-text u-text-default u-text-13">Allegato</h4>
                  </div>
                </div>
              </div>
            </div>
            <p class="u-align-center u-hover-feature u-text u-text-14"><span class="u-file-icon u-icon u-text-palette-4-base u-icon-1" data-href="<?php echo base_url('codeigniter/');?>" data-page-id="12247714" title="Home"><img src="<?php echo base_url();?>assets/images/69524-a9ccadc1.png" alt=""></span>&nbsp;
            </p>
          </div>
        </div>
      </div>
