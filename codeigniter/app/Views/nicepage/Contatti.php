...
<link rel="stylesheet" href="<?php echo base_url();?>assets/Contatti.css" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="it"><header class="u-clearfix u-header u-header" id="header" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        <a href="<?php echo base_url('codeigniter/');?>" class="u-image u-logo u-image-1" data-image-width="80" data-image-height="40">
...
<section class="u-clearfix u-section-1" id="contatti">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-border-3 u-border-palette-4-base u-container-style u-group u-radius u-group-1">
      <div class="u-container-layout u-valign-top u-container-layout-1">
        <h2 class="u-align-center u-text u-text-2" style="margin: 0;">Contatti</h2>
        ...
        <p class="u-text u-text-default" style="margin-top: 20px;">
          Per qualsiasi informazione, richiesta o segnalazione, puoi contattarci ai seguenti recapiti:
        </p>

        <ul style="list-style: none; padding-left: 0; margin-top: 30px;">
          <li><strong>Email:</strong> <a href="mailto:assistenzadisservizi@poliba.it">assistenzadisservizi@poliba.it</a></li>
          <br><li><strong>Telefono:</strong> +39 080 123 4567</li>
          <br><li><strong>Orari di disponibilità:</strong> Lun–Ven, 9:00–18:00</li>
        </ul>
