...
<html style="font-size: 16px;" lang="it"><head>
    ...
    <title>dashboard_amministratore_eliminaServizio</title>
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/dashboard_amministratore.css" media="screen">
    ...
    <meta property="og:title" content="dashboard_amministratore_eliminaServizio">
 ...
 <div id="formServizi"></div> <!-- PORTA LA PAGINA QUI --!>	               
			...
			<form action="<?php echo base_url('codeigniter/') ?>pagina_admin/elimina" method="post" style="margin-top: 20px;">
				<?= csrf_field() ?>
					<label for="id_servizio" style="display: inline-block;margin-left: 300px;"><h4>Servizio da eliminare:</h4></label>
					<select name="id_servizio" id="id_servizio" style="width:auto;display: inline-block;" class="u-border-3 u-border-palette-4-base u-input u-input-rectangle u-input-2">
						<?php foreach ($servizio as $servizio_i) {
							$id_servizio_i = $servizio_i['id_servizio'];
							$nome_servizio_i = $servizio_i['nome'];
							echo "<option value=\"$id_servizio_i\">$nome_servizio_i</option>";
						} ?>
					</select>
			<div style="display: flex; justify-content: center; gap: 50px; margin-top: 0px;margin-bottom: 5px;">
			  <button type="submit" name="submit" value="invia_elimina_servizio" style="margin-left: auto;margin-right: auto; border-style: solid; font-weight: 700; font-size: 1.25rem; --radius: 20px;"
