...
<html style="font-size: 16px;" lang="it"><head>
    ...
    <title>dashboard_amministratore_eliminaResponsabile</title>
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/dashboard_amministratore.css" media="screen">
    ...
    <meta property="og:title" content="dashboard_amministratore_eliminaResponsabile">
        ...
        <div class="u-border-3 u-border-palette-4-base u-container-style u-group u-radius u-group-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
          <div class="u-container-layout u-valign-bottom-lg u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-container-layout-1">
			...
			<form action="<?php echo base_url('codeigniter/') ?>pagina_admin/elimina" method="post" style="margin-top: 20px;">
				<?= csrf_field() ?>
					<label for="cf_responsabile" style="display: inline-block;"><h4>Responsabile da eliminare:</h4></label>
					<select name="cf_responsabile" id="cf_responsabile" style="width:auto;display: inline-block;" class="u-border-3 u-border-palette-4-base u-input u-input-rectangle u-input-2">
						<?php foreach ($responsabili as $responsabile) {
							$id_responsabile_i = $responsabile['cf'];
							$nome_responsabile_i = $responsabile['nome'];
							$cognome_responsabile_i = $responsabile['cognome'];
							echo "<option value=\"$id_responsabile_i\">$nome_responsabile_i $cognome_responsabile_i</option>";
						} ?>
					</select>
			<div style="display: flex; justify-content: center; gap: 10px; margin-top: 0px;">
			  <button type="submit" name="submit" value="invia_elimina_responsabile" style="margin-left: auto;margin-right: auto;"
				class="u-active-custom-color-6 u-border-3 u-border-active-palette-4-base u-border-hover-palette-4-base u-border-palette-4-base u-btn u-btn-round u-button-style u-palette-4-base u-radius u-text-active-palette-4-base u-text-palette-5-base u-btn-1">
				Invia modifiche
			  </button>
